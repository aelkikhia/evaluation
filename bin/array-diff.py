...
from evaluation.eval_lib import array_diff, social_network_analysis
...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--current', type=int, dest='current', nargs='+',
                        default=[], help='current comma separated list of elements')
    parser.add_argument('-t', '--target', type=int, dest='target', nargs='+',
                        default=[], help='target comma separated list of elements')
